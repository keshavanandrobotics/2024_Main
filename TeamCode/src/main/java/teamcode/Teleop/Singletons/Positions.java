...
public class Positions {
    ...
    public static double CLAW_CLOSED = 0.61;
    public static double CLAW_LOOSE_CLOSED = 0.65;
    public static double CLAW_OPEN = 0.78;
    public static double CLAW_LESS_OPEN = 0.71;

    public static double ROTATE_NEUTRAL = 0.3906;
    ...
    public static double MOVE_WALL_INTAKE = 0.94;


    public static double MOVE_OUTTAKE = 0.94;
    public static double MOVE_SPECIMEN_SCORE = 0.48;
    public static double MOVE_ALL_OUT = 0.47;
    public static double MOVE_HOVER_SAMPLE = 0.49;



    public static double MOVE_PICKUP_SAMPLE = 0.46;
    ...
    public static double PIVOT_SPECIMEN_SCORE = 0.46;
