...
public class LM3_Specimen extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder trajectory2 = robot.drive.actionBuilder(new Pose2d(18,0,0))
                .strafeToLinearHeading(new Vector2d(14.5, -22.95), Math.toRadians(-38));
        TrajectoryActionBuilder trajectory3 = robot.drive.actionBuilder(new Pose2d(14.5,-22.95,Math.toRadians(-38)))
        ...
        TrajectoryActionBuilder trajectory4 = robot.drive.actionBuilder(new Pose2d(14.5,-27.45,Math.toRadians(-120)))
                .strafeToLinearHeading(new Vector2d(14.5, -32.45), Math.toRadians(-38));

        TrajectoryActionBuilder trajectory5 = robot.drive.actionBuilder(new Pose2d(14.5,-32.45,Math.toRadians(-38)))
        ...
        TrajectoryActionBuilder trajectory6 = robot.drive.actionBuilder(new Pose2d(14.5,-22.45,Math.toRadians(-120)))
                .strafeToLinearHeading(new Vector2d(14.5, -42.45), Math.toRadians(-38));

        TrajectoryActionBuilder trajectory7 = robot.drive.actionBuilder(new Pose2d(14.5,-42.45,Math.toRadians(-38)))
                .strafeToLinearHeading(new Vector2d(14.5, -17.45), Math.toRadians(-120));

        TrajectoryActionBuilder trajectory8 = robot.drive.actionBuilder(new Pose2d(14.5,-17.45,Math.toRadians(-120)))
                .strafeToLinearHeading(new Vector2d(13.5, -3), Math.toRadians(-120));

        TrajectoryActionBuilder trajectory9 = robot.drive.actionBuilder(new Pose2d(13.5,-3,Math.toRadians(-120)))
