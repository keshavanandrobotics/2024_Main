...
public class LT_Specimen extends LinearOpMode {
    ...
    public class SpecimenHoverServos2 implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket telemetryPacket) {
            ...
            robot.clawMove.setPosition(MOVE_HOVER_SAMPLE + 0.1);

            if (robot.claw.getPosition()<(CLAW_OPEN -0.03)){
                robot.clawMove.setPosition(MOVE_HOVER_SAMPLE + 0.1);
                return true;
    ...
    public class ServosPickupSample implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket telemetryPacket) {
            ...
            if (getRuntime() - stamp < 0.26){
                robot.clawMove.setPosition(MOVE_PICKUP_SAMPLE + 0.015);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder trajectory1 = robot.drive.actionBuilder(new Pose2d(0,0,Math.toRadians(0)))
                .strafeToLinearHeading(new Vector2d(20, 12), Math.toRadians(0));

        TrajectoryActionBuilder trajectory2 = robot.drive.actionBuilder(new Pose2d(20,12,0))
                .strafeToLinearHeading(new Vector2d(14.8, -23), Math.toRadians(-38));
        TrajectoryActionBuilder trajectory3 = robot.drive.actionBuilder(new Pose2d(14.8,-23,Math.toRadians(-38)))
        ...
        TrajectoryActionBuilder trajectory4 = robot.drive.actionBuilder(new Pose2d(14.5,-27.45,Math.toRadians(-120)))
                .strafeToLinearHeading(new Vector2d(13.7, -32), Math.toRadians(-38));

        TrajectoryActionBuilder trajectory5 = robot.drive.actionBuilder(new Pose2d(13.7,-32,Math.toRadians(-38)))
        ...
        TrajectoryActionBuilder trajectory6 = robot.drive.actionBuilder(new Pose2d(14.5,-22.45,Math.toRadians(-120)))
                .strafeToLinearHeading(new Vector2d(14.65, -42.45), Math.toRadians(-38));

        TrajectoryActionBuilder trajectory7 = robot.drive.actionBuilder(new Pose2d(14.65,-42.45,Math.toRadians(-38)))
        ...
        TrajectoryActionBuilder trajectory10 = robot.drive.actionBuilder(new Pose2d(24,6,Math.toRadians(0)))
        ...
        if(opModeIsActive()){
            ...
            Actions.runBlocking(trajectory3.build() );
