...
public class SPEC_AUTO_VARS {
    ...
    public static double SAMPLE_SCORE_X1 = 5, SAMPLE_SCORE_Y1 = 68, SAMPLE_SCORE_TRAVELHEADING = -90; // TRAVELING TO BUCKET
    public static double SAMPLE_SCORE_X2 = 5, SAMPLE_SCORE_Y2 = 72, SAMPLE_SCORE_HEADING = -45; // ALIGNING TO BUCKET
