...
public class SPEC_AUTO_VARS {
    ...
    public static int EXTENDO_INITIAL_HUMAN_PLAYER = 2000/4; //POSITION BEFORE EXTENDO GOES IN AND GRABS 1ST SPEC

    public static int EXTENDO_GRAB_THRESHOLD = 0/4; //SHOULD NOT NEED EDITING, POSITION FOR EXTENDO IN WHERE ACTION ENDS

    public static int EXTENDO_SCORE_THRESHOLD = 5000/4; //SHOULD NOT NEED EDITING, POSITIONS FOR EXTENDO OUT WHERE ACTION ENDS
    public static int EXTENDO_CYCLE_HUMAN_PLAYER = 5000/4; //POSITION BEFORE EXTENDO GOES IN AND GRABS 2-5 SPEC

    public static int LINEAR_SLIDE_LOWER_THRESHOLD = 500/4; //SHOULD NOT NEED EDITING, POSITION WHERE LINEAR SLIDE LOWERING ACTION ENDS
