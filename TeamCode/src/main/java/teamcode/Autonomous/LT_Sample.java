...
public class LT_Sample extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder specimenScore = robot.drive.actionBuilder(new Pose2d(0,24,0))
                .strafeToConstantHeading(new Vector2d(5,0));

        TrajectoryActionBuilder specimenScore2 = robot.drive.actionBuilder(new Pose2d(5,0,0))
                .strafeToConstantHeading(new Vector2d(23,0));


        TrajectoryActionBuilder firstSamplePickup = robot.drive.actionBuilder(new Pose2d(23,0,0))
                .strafeToLinearHeading(new Vector2d(12, 41.7), Math.toRadians(0),
                        new TranslationalVelConstraint(35));

        TrajectoryActionBuilder firstSampleNet = robot.drive.actionBuilder(new Pose2d(12, 41.7, 0))
        ...
        TrajectoryActionBuilder secondSamplePickup = robot.drive.actionBuilder(new Pose2d(5, 50, Math.toRadians(-45)))
                .strafeToLinearHeading(new Vector2d(11.7,51), Math.toRadians(0),
                        new TranslationalVelConstraint(13));

        TrajectoryActionBuilder secondSampleNet = robot.drive.actionBuilder(new Pose2d(11.7 , 50, 0))

                .strafeToLinearHeading(new Vector2d(9,44), Math.toRadians(-45));


        TrajectoryActionBuilder thirdSamplePickup = robot.drive.actionBuilder(new Pose2d(5, 50, Math.toRadians(-45)))
                .strafeToLinearHeading(new Vector2d(35.8,31), Math.toRadians(90),
                        new TranslationalVelConstraint(20));

        TrajectoryActionBuilder thirdSampleNet = robot.drive.actionBuilder(new Pose2d(35.8 , 31, Math.toRadians(90)))
