...
import static teamcode.Teleop.Singletons.Positions.AUTO_PARK_SLIDE_POS;
...
import static teamcode.Teleop.Singletons.Positions.EXTENDO_MAX_TELE;
import static teamcode.Teleop.Singletons.Positions.HIGH_SAMPLE_POS;
import static teamcode.Teleop.Singletons.Positions.HIGH_SPECIMEN_POS;
import static teamcode.Teleop.Singletons.Positions.MOVE_ALL_OUT;
...
import static teamcode.Teleop.Singletons.Positions.MOVE_OUTTAKE;
...
import static teamcode.Teleop.Singletons.Positions.PIVOT_ALL_OUT;
import static teamcode.Teleop.Singletons.Positions.PIVOT_AUTONOMOUS_INIT;
import static teamcode.Teleop.Singletons.Positions.PIVOT_OUTTAKE;
...
import static teamcode.Teleop.Singletons.Positions.ROTATE_90;
...
public class LT4_Sample extends LinearOpMode{
    ...
    public class OuttakeServos2 implements Action {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder preLoadNet = robot.drive.actionBuilder(new Pose2d(0,0,0))
        ...
        if (opModeIsActive()){
            ...
            Actions.runBlocking(preLoadNet.build());
