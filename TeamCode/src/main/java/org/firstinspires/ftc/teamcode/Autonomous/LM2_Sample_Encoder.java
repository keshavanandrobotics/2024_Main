...
@Config
@Autonomous
public class LM2_Sample_Encoder extends LinearOpMode {
    ...
    public class SlidesUp implements Action{
        ...
        public boolean run(@NonNull TelemetryPacket telemetryPacket) {
            ...
            else if (robot.leftSlide.getCurrentPosition()<position){

                robot.leftSlide.setPower(1);
                robot.rightSlide.setPower(1);
                robot.centerSlide.setPower(1);
                
                TELE.addData("pos", robot.leftSlide.getCurrentPosition());
                TELE.update();
    ...
    public class SlidesDown implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket telemetryPacket) {
            ...
            else if (robot.rightSlide.getCurrent(CurrentUnit.AMPS)<3){
                robot.leftSlide.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                robot.centerSlide.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                robot.rightSlide.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder trajectory1f = robot.drive.actionBuilder(new Pose2d(7, 53, Math.toRadians(-45)))
                .strafeToLinearHeading(new Vector2d(41.5,40.9), Math.toRadians(90),
                        new TranslationalVelConstraint(23));


        TrajectoryActionBuilder trajectory2 = robot.drive.actionBuilder(new Pose2d(20.2, 41, 0))

                .strafeToLinearHeading(new Vector2d(6,47), Math.toRadians(-45));

        TrajectoryActionBuilder trajectory2e = robot.drive.actionBuilder(new Pose2d(20.8 , 51.2, 0))

                .strafeToLinearHeading(new Vector2d(6,47), Math.toRadians(-45));

        TrajectoryActionBuilder trajectory2f = robot.drive.actionBuilder(new Pose2d(41.5 , 40.9, Math.toRadians(90)))
        ...
        TrajectoryActionBuilder trajectorywww3 = robot.drive.actionBuilder(new Pose2d(7, 53, Math.toRadians(-45)))
                .splineToSplineHeading(new Pose2d(58,27,Math.toRadians(-90)), Math.toRadians(0),
                        new TranslationalVelConstraint(40))
                .splineToSplineHeading(new Pose2d(58,14,Math.toRadians(-90)), Math.toRadians(0),
                        new TranslationalVelConstraint(40));
        ...
        robot.centerSlide.setPower(-0.3);
